...
public class SwipeListViewTouchListener implements View.OnTouchListener {
     ...
     */
    private void setFrontView(final View frontView) {
            ...
            frontView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (downPosition != AdapterView.INVALID_POSITION
                        ...
                        swipeListView.onLongClickFrontView(frontView, downPosition);
                    }
                }
            });
        }
    ...
    private void setBackView(final View backView) {
        ...
        backView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                swipeListView.onClickBackView(backView, downPosition);
            }
        });
    }
