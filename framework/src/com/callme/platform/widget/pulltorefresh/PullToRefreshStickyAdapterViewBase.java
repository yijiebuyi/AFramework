...
public abstract class PullToRefreshStickyAdapterViewBase<T extends StickyListHeadersListView>
	 ...
	 * Pass-through method for {@link PullToRefreshBase#getRefreshableView()
	 * getRefreshableView()}.
	 * {@link AdapterView#setOnItemLongClickListener(OnItemLongClickListener)
	 * OnItemLongClickListener(listener)}. This is just for convenience!
	 *
	...
	private boolean isFirstItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			if (mRefreshableView.getFirstVisiblePosition() == 0) {
				final View firstVisibleChild = ((StickyListHeadersListView) mRefreshableView).getListChildAt(0);
	...
	private boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			if (lastVisiblePosition == lastItemPosition) {
				...
				final View lastVisibleChild = ((StickyListHeadersListView) mRefreshableView).getListChildAt(childIndex);
