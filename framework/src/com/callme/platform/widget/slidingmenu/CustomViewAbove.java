package com.callme.platform.widget.slidingmenu;
...
import com.callme.platform.widget.slidingmenu.SlidingMenu.OnClosedListener;
import com.callme.platform.widget.slidingmenu.SlidingMenu.OnOpenedListener;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                return !isMenuOpen() || mQuickReturn;
            case MotionEvent.ACTION_MOVE:
                if (!mIsBeingDragged) {
                    determineDrag(ev);
                    if (mIsUnableToDrag)
