...
public class EncryptUtil {
    ...
    public static String RSAPost(Context context, String url, Object entry,
        ...
        return HttpUtil.getInstance("application/jsonet", 0).post(url, params, responseHandler);*/
        return null;
    }
    ...
    public static String RSAPost(Context context, String url, Object entry, CmRequestImpListener<JSONObject> responseHandler,
        ...
        if (TYPE_RSA_BASE64 == type) {
            ...
            return HttpUtil.getInstance("application/jsone", 0).post(url, params, responseHandler);
        }*/
        return null;
    }
    ...
    public static byte[] getRsaData(RsaDataBean data) {
        ...
        String srcData = JsonUtils.toJSONString(data);
        byte[] rsaData = null;
        try {
    ...
    public static RsaDataBean buildRsaData(Object entry) {
        ...
        data.d = JsonUtils.toJSONString(entry);
        return data;
    }
