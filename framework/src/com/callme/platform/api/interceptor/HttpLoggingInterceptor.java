...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        boolean logHeaders = level == Level.ALL || level == Level.HEADERS;
        ...
        if (!logHeaders && hasRequestBody) {
            requestStartMessage += " (request: " + requestBody.contentLength() + "-byte body)";
        }
        ...
        String bodySize = contentLength != -1 ? "response: " + contentLength + "-byte" : "response: unknown-length";
